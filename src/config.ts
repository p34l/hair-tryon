...
export const EMA_ALPHA_STILL = 0.10;  // нижняя граница: СИЛЬНОЕ сглаживание в покое (без мерцания)
export const EMA_MOTION_GAIN = 18.0;  // насколько резко alpha растёт с движением
// Мёртвая зона движения: мелкие покадровые колебания маски (шум модели/камеры) НЕ
// считаем движением, иначе alpha зря растёт и маска «кипит»/блимает в покое.
export const EMA_MOTION_DEADZONE = 0.02;
